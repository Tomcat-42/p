...
pub fn visit(this: *const @This(), allocator: Allocator, visitor: Visitor) @typeInfo(@TypeOf(Visitor.visit_group_expr)).@"fn".return_type.? {
    return visitor.visit_group_expr(allocator, this);
}
