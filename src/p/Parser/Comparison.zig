...
pub fn visit(this: *const @This(), allocator: Allocator, visitor: Visitor) @typeInfo(@TypeOf(Visitor.visit_comparison)).@"fn".return_type.? {
    return visitor.visit_comparison(allocator, this);
}
