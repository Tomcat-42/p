...
pub fn visit(this: *const @This(), allocator: Allocator, visitor: Visitor) @typeInfo(@TypeOf(Visitor.visit_logic_or)).@"fn".return_type.? {
    return visitor.visit_logic_or(allocator, this);
}
