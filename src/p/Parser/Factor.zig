...
pub fn visit(this: *const @This(), allocator: Allocator, visitor: Visitor) @typeInfo(@TypeOf(Visitor.visit_factor)).@"fn".return_type.? {
    return visitor.visit_factor(allocator, this);
}
